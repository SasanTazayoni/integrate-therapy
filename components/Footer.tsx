    ...
    <footer id="site-footer" className="block--white footer__block">
        ...
        <ul className="list footer__list">
          {NAV_LINKS.map((label) => (
            <li key={label} className="footer__item">
              <Link href={getNavPath(label)} aria-label={`Go to ${label} page`}>
                {label}
              </Link>
            </li>
          ))}
      ...
      <div className="footer__bottom">
        <div className="footer__legal-links">
          ...
          <Link href="/terms" className="footer__privacy-link">
            Terms &amp; Conditions
          </Link>
          <Link href="/cookie-policy" className="footer__privacy-link">
            Cookie Policy
          </Link>
        </div>
